...
import com.example.gofund.viewmodel.ReportViewModel
...
fun ReportScreen(
    ...
    val totalExpense = viewModel.getCurrentExpenseTotal()
    val totalInvestment = viewModel.getCurrentInvestmentTotal()
        ...
        if (viewModel.isLoading.value) {
            ...
            Column(
                ...
                SingleChoiceSegmentedButtonRow(
                    ...
                    viewModel.reportOptions.forEachIndexed { index, option ->
                        SegmentedButton(
                            onClick = {
                            ...
                            shape = SegmentedButtonDefaults.itemShape(
                                index = index,
                                count = viewModel.reportOptions.size
                            )
                        ) {
                            Text(
                                text = option,
